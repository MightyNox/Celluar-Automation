...
namespace Beginning_of_Grain_Growth.src
{
    class Data
    {
        ...
        private bool show_energy;
        private double kt;
        private int[,] grid_energy;
        ...
        public bool Show_energy { get => show_energy; set => show_energy = value; }
        public double Kt { get => kt; set => kt = value; }
        public int[,] Grid_energy { get => grid_energy; set => grid_energy = value; }
        ...
        public void Initialize()
        {
            ...
            grid_energy = new int[horizontal_cells_num, vertical_cells_num];
